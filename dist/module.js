...
function (_super) {
  ...
  function SunAndMoonDataSource(instanceSettings) {
    ...
    _this.position = instanceSettings.jsonData;
    return _this;
  }
  ...
  SunAndMoonDataSource.prototype.query = function (options) {
    return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, Promise, function () {
      var range, from, to, maxDataPoints, stepInSeconds, targets, data;
      ...
      return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
        ...
        data = targets.map(function (target) {
          var frame = new _grafana_data__WEBPACK_IMPORTED_MODULE_4__["MutableDataFrame"]({
            refId: target.refId,
            name: target.alias || _types__WEBPACK_IMPORTED_MODULE_5__["sunAndMoonMetrics"][target.target],
            fields: [{
              name: 'Time',
          ...
          for (var time = from; time < to; time += stepInSeconds) {
            switch (target.target) {
              ...
              case 'moon_altitude':
                value = suncalc__WEBPACK_IMPORTED_MODULE_3__["getMoonPosition"](new Date(time), _this.position.latitude, _this.position.longitude).altitude * 180 / Math.PI;
                break;

              case 'moon_azimuth':
                value = suncalc__WEBPACK_IMPORTED_MODULE_3__["getMoonPosition"](new Date(time), _this.position.latitude, _this.position.longitude).azimuth * 180 / Math.PI;
                break;

              case 'moon_distance':
                value = suncalc__WEBPACK_IMPORTED_MODULE_3__["getMoonPosition"](new Date(time), _this.position.latitude, _this.position.longitude).distance;
                break;

              case 'sun_altitude':
                value = suncalc__WEBPACK_IMPORTED_MODULE_3__["getPosition"](new Date(time), _this.position.latitude, _this.position.longitude).altitude * 180 / Math.PI;
                break;

              case 'sun_azimuth':
                value = suncalc__WEBPACK_IMPORTED_MODULE_3__["getPosition"](new Date(time), _this.position.latitude, _this.position.longitude).azimuth * 180 / Math.PI;
                break;
            }
  ...
  SunAndMoonDataSource.prototype.annotationQuery = function (options) {
    return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, Promise, function () {
      var range, from, to, events, targets, date, sunTimes, moonTimes, values, setHours, noon, midnight, value, event;
      return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
        range = options.range;
        ...
        for (date = from; date < to; date.add(1, 'days')) {
          sunTimes = suncalc__WEBPACK_IMPORTED_MODULE_3__["getTimes"](date.toDate(), this.position.latitude, this.position.longitude);
          moonTimes = suncalc__WEBPACK_IMPORTED_MODULE_3__["getMoonTimes"](date.toDate(), this.position.latitude, this.position.longitude);
          ...
          for (value in values) {
            ...
            event = {
              ...
              title: _types__WEBPACK_IMPORTED_MODULE_5__["sunAndMoonAnnotations"][value].title,
              text: _types__WEBPACK_IMPORTED_MODULE_5__["sunAndMoonAnnotations"][value].text,
              tags: _types__WEBPACK_IMPORTED_MODULE_5__["sunAndMoonAnnotations"][value].tags
            };
            events.push(event);
          }
        }
...
var metrics = lodash_map__WEBPACK_IMPORTED_MODULE_2___default()(_types__WEBPACK_IMPORTED_MODULE_5__["sunAndMoonMetrics"], function (label, metric) {
  return {
    label: label,
    value: metric
  };
...
function (_super) {
  ...
  function QueryEditor() {
    ...
    _this.onAliasChanged = function (event) {
      var _a = _this.props,
          onChange = _a.onChange,
          query = _a.query,
          onRunQuery = _a.onRunQuery;
  ...
  QueryEditor.prototype.render = function () {
    ...
    return react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement("div", {
      ...
      className: "gf-form"
    }, react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_4__["InlineFormLabel"], null, "Alias"), react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_4__["Input"], {
      className: "alias",
      value: query.alias,
